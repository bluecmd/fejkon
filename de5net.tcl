...
set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to fcxcvr_0_line_rx_lvds     ; # SFPA_RX_p
...
set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to fcxcvr_0_line_tx_lvds     ; # SFPA_TX_p
...
set_location_assignment PIN_AK2 -to fcxcvr_0_line_rx_lvds                            ; # SFPA_RX_p
set_location_assignment PIN_B22 -to sfp0_txdis                                       ; # SFPA_TXDISABLE
set_location_assignment PIN_A22 -to sfp0_txfail                                      ; # SFPA_TXFAULT
set_location_assignment PIN_AG4 -to fcxcvr_0_line_tx_lvds                            ; # SFPA_TX_p
