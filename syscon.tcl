...
proc fcstat {id} {
  ...
  puts [format " VC_RDY    : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x01 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x02 * 4] 1]]
  puts [format " BB_SCS    : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x02 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x03 * 4] 1]]
  puts [format " BB_SCR    : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x03 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x04 * 4] 1]]
  puts [format " SOFi2     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x04 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x05 * 4] 1]]
  puts [format " SOFn2     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x05 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x06 * 4] 1]]
  puts [format " SOFi3     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x06 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x07 * 4] 1]]
  puts [format " SOFn3     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x07 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x08 * 4] 1]]
  puts [format " SOFf      : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x08 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x09 * 4] 1]]
  puts [format " EOFt      : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x09 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0a * 4] 1]]
  puts [format " EOFa      : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0a * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0b * 4] 1]]
  puts [format " EOFn      : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0b * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0c * 4] 1]]
  puts [format " EOFni     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0c * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0d * 4] 1]]
  puts [format " NOS       : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0d * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0e * 4] 1]]
  puts [format " OLS       : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0e * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x0f * 4] 1]]
  puts [format " LR        : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x0f * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x10 * 4] 1]]
  puts [format " LRR       : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x10 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x11 * 4] 1]]
  puts [format " ARBff     : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x11 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x12 * 4] 1]]
  puts [format " Unknown   : %s %s" [master_read_32 $m [expr $off + 0x80 + 0x12 * 4] 1] [master_read_32 $m [expr $off + 0x100 + 0x13 * 4] 1]]
}
