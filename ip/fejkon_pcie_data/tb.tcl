...
add_instance pcie_clk_0 clock_source 19.1
set_instance_parameter_value pcie_clk_0 {clockFrequency} {100000000.0}
set_instance_parameter_value pcie_clk_0 {clockFrequencyKnown} {1}
set_instance_parameter_value pcie_clk_0 {resetSynchronousEdges} {NONE}
...
set_interface_property bar2_mm EXPORT_OF pcie_data.bar2_mm
add_interface clk clock sink
set_interface_property clk EXPORT_OF pcie_clk_0.clk_in
...
add_interface phy_hip_ctrl conduit end
set_interface_property phy_hip_ctrl EXPORT_OF phy.hip_ctrl
add_interface phy_hip_pipe conduit end
set_interface_property phy_hip_pipe EXPORT_OF phy.hip_pipe
add_interface phy_hip_serial conduit end
set_interface_property phy_hip_serial EXPORT_OF phy.hip_serial
add_interface phy_npor conduit end
set_interface_property phy_npor EXPORT_OF phy.npor
add_interface reset reset sink
set_interface_property reset EXPORT_OF pcie_clk_0.clk_in_reset

# connections and connection parameters
add_connection pcie_clk_0.clk msi_intr.clk

add_connection pcie_clk_0.clk pcie_reconfig.pld_clk

add_connection pcie_clk_0.clk pcie_reconfig.reconfig_xcvr_clk

add_connection pcie_clk_0.clk phy.refclk

add_connection pcie_clk_0.clk xcvr_reconfig.mgmt_clk_clk

add_connection pcie_clk_0.clk_reset msi_intr.reset

add_connection pcie_clk_0.clk_reset pcie_data.reset

add_connection pcie_clk_0.clk_reset pcie_reconfig.reconfig_xcvr_rst

add_connection pcie_clk_0.clk_reset xcvr_reconfig.mgmt_rst_reset
