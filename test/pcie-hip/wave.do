...
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_data
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_empty
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_endofpacket
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_error
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_ready
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_startofpacket
add wave -noupdate -expand -group phy_rx_st /tb/svpcie/endp0_rx_st_valid
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_data
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_empty
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_endofpacket
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_error
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_ready
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_startofpacket
add wave -noupdate -expand -group phy_tx_st /tb/svpcie/intel_pcie_tlp_adapter_phy_tx_st_valid
...
add wave -noupdate -group rx_bar /tb/svpcie/endp0_rx_bar_be_rx_st_mask
...
update
WaveRestoreZoom {88450166 ps} {88677733 ps}
