...
# CLOCK
#============================================================
set_instance_assignment -name IO_STANDARD "2.5 V" -to clk_clk     ; # OSC_50_B3B
...
set_location_assignment PIN_AW35 -to clk_clk ; # OSC_50_B3B
...
set_instance_assignment -name IO_STANDARD "2.5 V" -to fcport0_xcvr_line_tx_lvds ; # LED_RJ45_L
set_instance_assignment -name IO_STANDARD "2.5 V" -to fcport0_xcvr_line_rx_lvds ; # LED_RJ45_R
...
set_location_assignment PIN_AG15 -to fcport0_xcvr_line_tx_lvds ; # LED_RJ45_L
set_location_assignment PIN_AG16 -to fcport0_xcvr_line_rx_lvds ; # LED_RJ45_R
...
set_instance_assignment -name IO_STANDARD "2.5 V" -to reset_reset_n ; # CPU_RESET_n
...
set_location_assignment PIN_BC37 -to reset_reset_n ; # CPU_RESET_n
...
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_RX_p[4]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_RX_p[5]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_RX_p[6]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_RX_p[7]
...
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_TX_p[4]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_TX_p[5]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_TX_p[6]
# set_instance_assignment -name IO_STANDARD "1.5-V PCML" -to PCIE_TX_p[7]
