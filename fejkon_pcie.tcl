...
set_instance_parameter_value phy {completion_timeout_hwtcl} {A}
set_instance_parameter_value phy {device_id_hwtcl} {3557}
set_instance_parameter_value phy {dll_active_report_support_hwtcl} {0}
set_instance_parameter_value phy {ecrc_check_capable_hwtcl} {1}
set_instance_parameter_value phy {ecrc_gen_capable_hwtcl} {1}
...
set_instance_parameter_value phy {enable_power_on_rst_pulse_hwtcl} {1}
...
set_instance_parameter_value phy {extend_tag_field_hwtcl} {64}
...
set_instance_parameter_value phy {max_payload_size_hwtcl} {512}
...
set_instance_parameter_value phy {use_aer_hwtcl} {1}
